...
namespace cs_packages.vehicle
{
    public class Handling : Events.Script
    {
        ...
        {
            if (vehicle._GetSharedData<int>("sd_Handling") == null || vehicle._GetSharedData<int>("sd_EngineMod") == null) return;//todo протестировать
            int handling = (int)vehicle._GetSharedData<int>("sd_Handling");
